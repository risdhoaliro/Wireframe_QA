...
const clients: Client[] = Array(10).fill(null).map((_, i) => ({
  businessName: 'BCA',
  businessOwner: {
    name: 'Jane Doe',
  ...
  lastSubscription: 'Platinum',
  purchasedContacts: '1K',
  registeredAt: '20-12-2024 08:30',
  status: 'Active',
}));
                    ...
                    <div className="flex items-center">
                      <div className="h-8 w-8 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                        <span className="text-sm font-medium text-gray-600 dark:text-gray-300">
                          {client.businessOwner.name.charAt(0)}
                        </span>
                      </div>
                      <div className="ml-4">
                        <div className="text-sm font-medium text-gray-900 dark:text-white">
                          {client.businessOwner.name}
                        </div>
                        <div className="text-sm text-gray-500 dark:text-gray-400">
                          {client.businessOwner.email}
                        </div>
                        <div className="text-sm text-gray-500 dark:text-gray-400">
                          {client.businessOwner.phone}
                        </div>
                      </div>
                    </div>
                  </td>
          ...
          <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            ...
            <div>
              <nav className="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                ...
                <button className="relative inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-300">
                  1
                </button>
                <button className="relative inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 bg-emerald-50 dark:bg-emerald-900 text-sm font-medium text-emerald-600 dark:text-emerald-300">
                  2
                </button>
                <button className="relative inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-sm font-medium text-gray-700 dark:text-gray-300">
                  3
